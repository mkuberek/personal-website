...
export const HeroSection: React.FC = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center px-3 py-12 md:px-4 md:py-20 overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10 w-full">
        ...
        <div className="mt-8 md:mt-12 space-y-6">
          {/* Trading Stats Style */}
          <div className="max-w-2xl mx-auto bg-gray-900/40 border border-gray-800/50 rounded-xl p-4 md:p-6 backdrop-blur-sm">
            <div className="grid grid-cols-3 gap-2 md:gap-4 text-center mb-3 md:mb-4">
              <div>
                <div className="text-orange-400/60 text-[10px] md:text-xs font-rajdhani tracking-wider mb-1">DAILY RETURNS</div>
                <div className="text-white font-orbitron font-bold text-sm md:text-lg">4-5 FIGS</div>
              </div>
              <div className="border-l border-r border-gray-800">
                <div className="text-orange-400/60 text-[10px] md:text-xs font-rajdhani tracking-wider mb-1">STRATEGY</div>
                <div className="text-white font-orbitron font-bold text-sm md:text-lg">PROP FIRMS</div>
              </div>
              <div>
                <div className="text-orange-400/60 text-[10px] md:text-xs font-rajdhani tracking-wider mb-1">EXPERIENCE</div>
                <div className="text-white font-orbitron font-bold text-sm md:text-lg">SELF-TAUGHT</div>
              </div>
            </div>
        ...
        <div className="mt-10 md:mt-16 flex flex-row gap-2 md:gap-4 justify-center items-center">
          <a
          ...
          >
            <span className="flex items-center justify-center gap-1.5 md:gap-2">
              ...
              <span className="xs:hidden sm:hidden">IG</span>
            </span>
          </a>
