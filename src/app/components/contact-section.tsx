  ...
  return (
    <section className="py-20 px-4">
      <div className="max-w-4xl mx-auto">
        <h2 className="text-3xl md:text-4xl font-orbitron font-black mb-12 text-center bg-gradient-to-r from-orange-300/80 via-amber-300/70 to-orange-400/60 bg-clip-text text-transparent tracking-wider uppercase">
          Connect
        </h2>
        ...
        <div className="bg-gradient-to-br from-gray-900/80 to-gray-800/80 backdrop-blur-sm rounded-2xl p-8 md:p-12 border border-gray-700 shadow-2xl">
          <div className="text-center mb-8">
            <p className="text-gray-300 text-lg font-rajdhani mb-6">
          ...
          <div className="flex flex-col gap-6">
            ...
            >
              ...
              <div className="text-left">
                <div className="text-sm text-orange-200/80 font-rajdhani tracking-wider uppercase">Email</div>
                <div className="text-white font-rajdhani font-bold">contact@matteokuberek.com</div>
              </div>
            </a>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              >
                ...
                <span className="text-white font-rajdhani font-bold tracking-wider">@matteokuberek</span>
              </a>
            </div>
          </div>
        </div>
